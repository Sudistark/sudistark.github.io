...
{% linkpreview "https://developers.google.com/workspace/gmail/ampemail" %}
...
{% linkpreview "https://web.archive.org/web/20250720221337/https://research.securitum.com/xss-in-amp4email-dom-clobbering/" %}

Second one is this, which involves an HTML parsing quirk from [@agamimaulana](https://x.com/agamimaulana). 


{% linkpreview "https://asdqw3.medium.com/xss-in-gmail-dynamic-email-amp-for-email-3872d6052a0d" %}
...
{% linkpreview "https://github.com/ckeditor/ckeditor4/security/advisories/GHSA-fq6h-4g8v-qqvm" %}
...
{% linkpreview "https://github.com/cure53/dompurify?tab=readme-ov-file#hooks" %}
...
{% linkpreview "https://mizu.re/post/exploring-the-dompurify-library-bypasses-and-fixes" %}

{% linkpreview "https://mizu.re/post/exploring-the-dompurify-library-hunting-for-misconfigurations" %}
...
{% linkpreview "https://x.com/S1r1u5_/status/1837431552676188491" %}
...
{% linkpreview "https://web.archive.org/web/20220903190106/https://research.securitum.com/mutation-xss-via-mathml-mutation-dompurify-2-0-17-bypass/" %}

{% linkpreview "https://portswigger.net/research/bypassing-dompurify-again-with-mutation-xss" %}
...
{% linkpreview "https://flatt.tech/research/posts/bypassing-dompurify-with-good-old-xml/" %}
